...
Generate report | http://10.1.1.16:8000/genReport/ | GET | sensorID, startTime, stopTime | min, max, mean, sd, filename
Send report | http://10.1.1.16:8000/sendReport/ | GET | filename, emailID | sentstatus
